...
const steps = [
  {
    ...
    icon: "💻" // We'll use emoji as placeholders, replace with proper icons later
  },
  {
    number: 2,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="flex flex-col items-center text-center">
              ...
              <div className="bg-navy-800/50 rounded-lg p-6 w-full">
                <div className="w-20 h-20 mx-auto bg-navy-700 rounded-full flex items-center justify-center text-3xl mb-4">
                  {step.icon}
                </div>
