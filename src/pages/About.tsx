...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About Us - AHLN Smart Delivery System</title>
        <meta name="description" content="Learn about AHLN's mission to revolutionize package delivery with smart, secure solutions." />
      </Helmet>
